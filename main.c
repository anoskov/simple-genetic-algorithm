 ...
 */
void
init_population (genome_struct * population, genome_struct * beta_population)
{
 ...
 */
void
calculate_fitness (genome_struct * population)
{
  int index = 0;
...
{
  return ((genome_struct *) e1)->fitness - ((genome_struct *) e2)->fitness;
}
 ...
 */
void
sort_by_fitness (genome_struct * population)
{
  qsort (population, POPSIZE, sizeof (genome_struct), sort_func);
}
 ...
 */
void
elitism (genome_struct * population, genome_struct * beta_population, int esize)
{
 ...
 */
void
mate (genome_struct * population, genome_struct * beta_population)
{
 ...
 */
void
decode_gen (genome_struct * member)
{
 ...
 */
void
free_population (genome_struct * population)
{
  int index = 0;
  for (; index < POPSIZE; index++)
    {
 ...
 */
void
swap (genome_struct ** p1, genome_struct ** p2)
{
  genome_struct *tmp = *p1;
  *p1 = *p2;
  *p2 = tmp;
}
...
main (void)
{
  ...
  genome_struct *population = malloc (sizeof (genome_struct) * POPSIZE);
  genome_struct *beta_population = malloc (sizeof (genome_struct) * POPSIZE);
